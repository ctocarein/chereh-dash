...
import { Eye, EyeOff, ArrowRight, Activity, Shield, Users, BarChart2 } from "lucide-react";
...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      login(res.data.token, res.data.identity, res.data.security_gate, email);
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg)" }}>
      ...
      >
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <button
                ...
                style={{ position: "absolute", right: "12px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: "var(--text-3)", cursor: "pointer", padding: 0, display: "flex" }}
              >
        ...
        <p style={{ marginTop: "40px", fontSize: "0.7rem", color: "var(--text-3)", textAlign: "center" }}>

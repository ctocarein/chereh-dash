...
const quickLinks = [
  { label: "Gérer les questions",    href: "/questionnaires",  desc: "Catalogue & blocs thématiques" },
  { label: "Voir les évaluations",   href: "/evaluations",     desc: "Sessions patients en cours" },
  { label: "Ambassadeurs actifs",    href: "/ambassadeurs",    desc: "Referrals & niveaux" },
  { label: "Modèles de risque",      href: "/decisions",       desc: "Scoring & versions" },
];
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: "16px" }}>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "12px", overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid var(--border)" }}>
            ...
            <Link href="/evaluations" style={{ fontSize: "0.72rem", color: "var(--brand)", display: "flex", alignItems: "center", gap: "4px" }}>
